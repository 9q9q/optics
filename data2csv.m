...
% !!!!!!!!!! change below line to whatever the name of yourr response data file is
resp_filename = "sub_1_sess_1_data.mat";
...
sub = str2num(resp_filename(5));
sess = str2num(resp_filename(12));
